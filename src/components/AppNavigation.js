...
import AvailableVehiclesMapViewScreen from '../screens/AvailableVehiclesMapViewScreen';
import AvailableRidesMapViewScreen from '../screens/AvailableRidesMapViewScreen';
...
function DriverStackScreen() {
    return (
        <DriverStack.Navigator>
            ...
            <RiderStack.Screen name="Available Rides - Map" component={AvailableRidesMapViewScreen} />
...
function RiderStackScreen() {
    return (
        <RiderStack.Navigator>
            ...
            <RiderStack.Screen name="Available Vehicles - Map" component={AvailableVehiclesMapViewScreen} />
        ...
        // <Tab.Screen name="Home" component={HomeScreen} options={{ tabBarBadge: 3 }} />
            ...
            >
                ...
                <Tab.Screen name="Home" component={HomeStackScreen}
                            options={{
                                tabBarIcon:() =>(
                                    <Ionicons name="home" size={30} color="#8f8d8d"/>
                                ),}}
                />
                <Tab.Screen name="Driver" component={DriverStackScreen}
                            options={{
                                tabBarIcon:() =>(
                                    <Ionicons name="directions-car" size={30} color="#2b1153" />
                                ),
